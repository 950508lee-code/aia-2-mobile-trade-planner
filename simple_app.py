...
def tab_process():
    ...
    st.markdown("<h2 style='font-size: 1.8rem; margin: 20px 0; color: #2c3e50;'>📊 <strong>단계별 투자 프로세스</strong></h2>", unsafe_allow_html=True)
...
def tab_start():
    ...
    st.markdown("<h2 style='font-size: 1.8rem; margin: 20px 0; color: #2c3e50;'>💡 <strong>시작하기 전에</strong></h2>", unsafe_allow_html=True)
...
def tab_ticker():
    """종목분석가 탭 - 임시"""
    st.header("📈 종목분석가")
    st.markdown("**개별 종목 심층 분석 및 투자 가치 평가**")
    st.info("종목분석가 기능을 개발 중입니다.")
